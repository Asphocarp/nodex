...
Only selected document-bearing Block types own independent Documents. Card and Synced Block sources are registered now; reusable templates, large explicit code/documents, and canvas scenes may be added later through the same Module. Promotion and demotion are explicit transactions.
