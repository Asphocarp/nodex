...
- [ ] Replace the renderer Canvas Y.Doc surface with a Canvas scene provider, durable outbox, coalescing, reconnect/gap repair, write leases, and app-close flush.
