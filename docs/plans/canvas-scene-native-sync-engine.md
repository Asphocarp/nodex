...
- [x] (2026-07-13 03:41Z) Implemented the Canvas scene store kernel, exact receipts, engine-native history/restore, backup validation, retention/GC, transfer/deletion routing, and primary/additional owner creation; removed the duplicated whole-scene materialization from v71 runtime while retaining an isolated v68-v70 migration seam.
