...
- **`docs/ARCHITECTURE.md`** — read the system ownership and dependency flow before changing a Module or Interface, then follow its links to the relevant narrow source of truth.
