...
- Card Stage retains its existing ordered drag sessions with Kanban. Toggle List summary rows do not export or accept body snapshots; cross-Document body movement remains unavailable there until the atomic Block relocation protocol owns the operation.
