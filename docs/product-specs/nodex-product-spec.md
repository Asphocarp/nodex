...
- Sidebar rows use compact project folder and session row chrome, including top actions for New chat, Search, Plugins, and Automations. Sessions are nested under project folders and can show a subtle attached-thread indicator.
