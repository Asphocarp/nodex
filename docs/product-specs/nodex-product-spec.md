...
- Sending from a card/editor to `New chat` reuses the current project's blank session or creates one, starts a session-owned thread there, and keeps focus in the current editor/card surface.
