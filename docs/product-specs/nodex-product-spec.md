...
Fresh Profiles use Store v100. Exact v99 Stores are backed up and atomically migrated by preserving existing Property rows byte-for-byte, widening the Property type checks, and publishing normalized Relation authority. Drifted or partially migrated inventories fail closed.
