import type { ThreadAgentActivityGroupSummaryStats } from "../thread-stage-types";

export interface AgentActivityGroupSummaryOptions {
...
function formatExplorationSummaryPart(stats: ThreadAgentActivityGroupSummaryStats, isLeading: boolean): string | null {
  const parts: string[] = [];
...
function addCommandSummaryParts(
  parts: string[],
  stats: ThreadAgentActivityGroupSummaryStats,
  showRunningCommandSummary: boolean,
): void {
...
function formatMcpSourceName(source: ThreadAgentActivityGroupSummaryStats["mcpToolCallSources"][number]): string {
...
export function buildAgentActivityGroupSummary(
  stats: ThreadAgentActivityGroupSummaryStats,
  options: AgentActivityGroupSummaryOptions = {},
