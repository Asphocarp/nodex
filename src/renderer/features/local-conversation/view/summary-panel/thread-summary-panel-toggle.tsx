...
export const ThreadSummaryPanelToggleButton = forwardRef<
  HTMLButtonElement,
  ThreadSummaryPanelToggleButtonProps
>(function ThreadSummaryPanelToggleButton(
  { pressed, label = "Toggle pinned summary", className, type = "button", ...buttonProps },
  ref,
) {
