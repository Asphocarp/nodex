...
export const threadMessageActionButtonClassName = `
  ...
  cursor-pointer flex items-center gap-1 border focus:outline-none
...
export function ThreadActionIconButton({
  ...
  const button = (
    <button
      type="button"
      className={cn(threadMessageActionButtonClassName, className)}
      aria-label={label}
      data-state={state}
      {...props}
    >
...
export function ThreadMessageActionRow({
  ...
  return (
    <div
      className={cn(
        "flex items-start gap-0.5 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100",
        align === "end" ? "mr-1 ms-1" : "pl-1",
        className,
      )}
    >
      {children}
...
export function CopyMessageIcon() {
  return (
    <svg
      width="21"
      height="21"
...
export function CopyMessageActionButton({
  ...
  return (
    ...
    >
      {copied ? <CheckmarkIcon className="icon-2xs" /> : <CopyMessageIcon />}
    </ThreadActionIconButton>
  );
}

export function EditMessageIcon() {
  return (
    <svg
      width="21"
      height="21"
...
export function ForkMessageIcon() {
  return (
    <svg
      width="20"
      height="20"
