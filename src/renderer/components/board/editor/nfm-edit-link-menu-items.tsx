...
import { useExtension, type LinkToolbarProps } from "./nfm-link-toolbar-deps";
...
export function useNfmLinkEditorState(props: NfmLinkEditorProps) {
  ...
  const submit = useCallback(
    (overrideUrl?: string, overrideText?: string) => {
