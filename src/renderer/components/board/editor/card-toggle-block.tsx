import { addDefaultPropsExternalHTML, createBlockSpec, createToggleWrapper } from "@blocknote/core";
import {
  classifyMetaToken,
...
export const createPageToggleBlockSpec = createBlockSpec(cardToggleBlockConfig, {
  meta: {
    isolating: false,
  },
  render(block, editor) {
