 ...
 */
export function DateMentionCalendarTestSurface({ hasEndDate }: DateMentionCalendarProps) {
  return (
    <div aria-label="Date mention calendar" data-selection-mode={hasEndDate ? "range" : "single"} />
  );
}
