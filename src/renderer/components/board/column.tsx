...
import { bindBoardColumnDropSurface } from "./column-drop-surface";
import type {
...
export const Column = memo(function Column({
  ...
  useEffect(() => {
    return bindBoardColumnDropSurface({
      columnId: column.id,
      columnDropDisabled,
      dragInstanceId,
  ...
  return (
    <div
      ...
      data-board-column-collapsed={isCollapsed ? "true" : "false"}
      ...
      style={{
        width: isCollapsed ? COLLAPSED_BOARD_COLUMN_WIDTH : layout.width,
