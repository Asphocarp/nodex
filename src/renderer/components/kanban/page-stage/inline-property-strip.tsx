...
import {
  pageStagePropertyEmptyValue,
  pageStagePropertyEmptyValueInteractive,
  pageStagePropertyInputChrome,
...
interface PageStageInlinePropertyStripProps {
  priority?: Priority;
  estimate: string;
  dueDate: string;
...
export function PageStageInlinePropertyStrip({
  ...
  onSetDueDateToday,
  onColumnChange,
}: PageStageInlinePropertyStripProps) {
  return (
    <div className="mb-3">
            ...
            triggerButton={(
              ...
              >
                {resolveKanbanPriorityOption(priority) ? (
                  ...
                  <span className={pageStagePropertyEmptyValue}>Empty</span>
                )}
              </NodexDropdownButtonTrigger>
            )}
          />
        ...
        <div className="flex h-7.5 items-center px-1.5">
          {dueDate ? (
            ...
            <button
              ...
              className={pageStagePropertyEmptyValueInteractive}
            >
              Empty
            </button>
          )}
