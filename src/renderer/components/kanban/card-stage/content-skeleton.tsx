...
function CardStageSkeletonBlock({ className }: { readonly className?: string }) {
  return (
    <div
...
export function CardStageContentSkeleton({
  titleSnapshot,
  announce = true,
}: {
  ...
  const label = title ? `Loading ${title}` : "Loading card";
