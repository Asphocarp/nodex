...
function ToolActionIcon(props: SVGProps<SVGSVGElement>) {
  return (
...
function RunActionIcon(props: SVGProps<SVGSVGElement>) {
  return (
...
function DebugActionIcon(props: SVGProps<SVGSVGElement>) {
  return (
...
function TestActionIcon(props: SVGProps<SVGSVGElement>) {
  return (
...
const ACTION_ICON_OPTIONS: Array<{
  ...
  icon: ActionIconComponent;
    ...
    { value: "tool", label: "Tool", icon: ToolActionIcon },
    { value: "run", label: "Run", icon: RunActionIcon },
    { value: "debug", label: "Debug", icon: DebugActionIcon },
    { value: "test", label: "Test", icon: TestActionIcon },
  ];
