...
describe("semantic Property option authority", () => {
  test("orders fixed semantic identities independently of renamed labels", () => {
    expect(
      orderSemanticPropertyOptions("status", [
        { id: "review", name: "QA" },
