...
type KanbanStore = ReturnType<typeof getKanbanProjectStore>;

export async function deleteKanbanPage(input: {
...
export async function moveKanbanPage(input: {
  readonly store: KanbanStore;
  readonly projectId: string;
...
export async function moveKanbanPages(input: {
  readonly store: KanbanStore;
  readonly projectId: string;
