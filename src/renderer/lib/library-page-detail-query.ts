...
const resolveLibraryPageDetailAuthority = (_queryKey: readonly unknown[], data: unknown) => {
  const authorization = (
    data as {
...
export const libraryPageDetailQueryOptions = (
  ...
  queryOptions({
    ...
    queryFn: async () => {
      ...
      return await admitResourceAuthorityQuery(result.value, resolveLibraryPageDetailAuthority);
    },
