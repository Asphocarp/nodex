...
export const writeTaskShorthandPagePromotionEnabled = (value: boolean): boolean => {
  ...
  if (typeof window !== "undefined") {
    window.dispatchEvent(
      new CustomEvent(TASK_SHORTHAND_PAGE_PROMOTION_CHANGE_EVENT, { detail: { enabled: value } }),
    );
  }
  return stored;
};
