...
import { resolveBrowserProfileHelperExecutable } from
  "./browser-profile-helper-client";

describe("resolveBrowserProfileHelperExecutable", () => {
  test("resolves explicit, packaged, and development executables", () => {
    expect(resolveBrowserProfileHelperExecutable({
      environment: {
    ...
    expect(resolveBrowserProfileHelperExecutable({
      ...
      "/Applications/Nodex.app/Contents/Resources/bin/nodex-browser-profile-helper",
    );
    expect(resolveBrowserProfileHelperExecutable({
      environment: {},
      isPackaged: false,
      ...
      "/work/nodex",
      "target/debug/nodex-browser-profile-helper",
    ));
  });
