  ...
  const applyDiscoveryPage = Effect.fn("CodexSubagentDirectory.applyDiscoveryPage")(function* (
    ...
    yield* core.workspace
      ...
      .pipe(
        ...
        // Discovery has the same commit/receipt ambiguity as status evidence. Always tell
        // observers to re-read; a redundant bounded read is safer than a permanently stale tree.
        Effect.ensuring(publishOverviewInvalidation(context)),
      );
