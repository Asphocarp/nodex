...
export const CODEX_COMMAND_REGISTRY: CommandRegistryEntry[] = [
  ...
  command("openThreadInNewWindow", "Open in new window", "Open the current chat in a new window", 40, "app", []),
  ...
  command("toggleTerminal", "Toggle terminal", "Focus or open the active terminal", 160, "app", ["Ctrl+`"]),
  ...
  command("searchFiles", "Search files", "Search files in the command palette", 210, "app", ["CmdOrCtrl+P"]),
  command("openCommandMenu", "Open command menu", "Open the command palette", 220, "app", ["CmdOrCtrl+K", "CmdOrCtrl+Shift+P"], {
    allowsMultiple: true,
  }),
