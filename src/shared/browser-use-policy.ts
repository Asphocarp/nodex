...
export const BrowserUseApprovalModeSchema = z.enum([
  "alwaysAsk",
  "neverAsk",
]);
export const BrowserUsePolicyResourceSchema = z.enum([
  "origin",
  "download",
  "upload",
  "fullCdp",
...
export const BrowserUsePolicyModesUpdateSchema = z.strictObject({
...
>;
export type BrowserUsePolicyResource = z.infer<
  typeof BrowserUsePolicyResourceSchema
>;
export type BrowserUsePolicySnapshot = z.infer<
  typeof BrowserUsePolicySnapshotSchema
>;
export type BrowserUsePolicyModesUpdate = z.infer<
  typeof BrowserUsePolicyModesUpdateSchema
>;
export type BrowserUseOriginRuleUpdate = z.infer<
  typeof BrowserUseOriginRuleUpdateSchema
>;
