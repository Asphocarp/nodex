...
export type PageDocumentPatchField =
  (typeof PAGE_DOCUMENT_PATCH_FIELDS)[number];

export type PageMetadataPatch = Partial<
  Omit<PageInput, PageDocumentPatchField>
>;
...
export const findPageDocumentPatchFields = (
  patch: object,
): readonly PageDocumentPatchField[] =>
  PAGE_DOCUMENT_PATCH_FIELDS.filter((field) => Object.hasOwn(patch, field));

export const assertPageUpdateExcludesDocumentContent = (
  patch: object,
): void => {
