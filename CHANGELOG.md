...
### Added
- Added a headless native `nodex` CLI for exact Page body/metadata reads, bounded history/tree inspection, guarded title and whole-body replacement, and simultaneous exact body patches through the same collaborative Core authority used by the desktop app.
