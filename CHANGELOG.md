...
### Fixed
- Fixed Card Stage long-description saves so save acknowledgements no longer echo full descriptions through renderer state, reducing input lag while `Saving...` is shown.
