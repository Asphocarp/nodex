...
- Settings and shared form controls now use a cleaner Codex Electron-style shell, thinner inputs, shared validation, and matching theme tokens.
...
- Active and mounted thread transcripts now match Codex Electron more closely for live-state rendering, request cards, transcript item types, expand/collapse behavior, and above-composer todo/diff surfaces.
