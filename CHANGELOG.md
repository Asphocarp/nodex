...
- Fixed Review so it remains responsive while agents stream and edit large worktrees: Git-backed diffs now use generation-consistent live metadata, batched partial bodies, real diff virtualization, and viewport-gated full context without recomputing whole-file diffs; binary, oversized, generated, and otherwise non-renderable bodies stay out of rendering and search.
