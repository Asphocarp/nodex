...
- Added a left-side Thread user-message navigation rail for longer conversations, with hover previews, output pills, restored long-thread position, smooth click jumps, and drag scrubbing.
