...
- Added ephemeral panel previews for Files and Browser tabs in either right or bottom panel; they replace the prior preview in the same Window Session panel and persist locally only after the user interacts with or pins the preview.
