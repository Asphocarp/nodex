...
const COMMANDS: &[CommandMetadata] = &[
    ...
    CommandMetadata {
        ...
        effect: CommandEffect::Read,
        validators: &["project_authorization", "bounded_manifest"],
        result: "page_file_manifest",
        errors: READ_ERRORS,
    ...
    CommandMetadata {
        ...
        capability: "pageFiles",
        effect: CommandEffect::Read,
        validators: &["project_authorization", "bounded_bytes"],
        result: "page_file_bytes_or_download_receipt",
        errors: READ_ERRORS,
        example: "nodex page file read @page-id --file references/api.md --output -",
        example_argv: &[
            "page",
            "file",
            "read",
    ...
    CommandMetadata {
        ...
        result: "page_file_mutation_receipt",
        errors: PAGE_FILE_ERRORS,
        example: "nodex --json page file put @page-id --path prototype/app.ts --from ./app.ts --idempotency-key file-put-1",
        example_argv: &[
            "--json",
            "page",
            "file",
    ...
    CommandMetadata {
        ...
        result: "page_file_mutation_receipt",
        errors: PAGE_FILE_ERRORS,
        example: "nodex --json page file rename @page-id --file app.ts --to prototype/app.ts --idempotency-key file-rename-1",
        example_argv: &[
            "--json",
            "page",
            "file",
    ...
    CommandMetadata {
        ...
        result: "page_file_mutation_receipt",
        errors: PAGE_FILE_ERRORS,
        example: "nodex --json page file delete @page-id --file app.ts --idempotency-key file-delete-1",
        example_argv: &[
            "--json",
            "page",
            "file",
    ...
    CommandMetadata {
        path: &["page", "file", "versions"],
        capability: "pageFiles",
        effect: CommandEffect::Read,
        validators: &["project_authorization", "bounded_manifest"],
        result: "page_file_versions",
        errors: READ_ERRORS,
        example: "nodex --json page file versions @page-id --file app.ts",
        example_argv: &[
            "--json", "page", "file", "versions", "@page-id", "--file", "app.ts",
        ],
    },
    CommandMetadata {
        path: &["page", "file", "restore"],
        capability: "pageFiles",
        effect: CommandEffect::Write,
        validators: &[
            "project_authorization",
        ...
        result: "page_file_mutation_receipt",
        errors: PAGE_FILE_ERRORS,
        example: "nodex --json page file restore @page-id --file @file-id --version 1 --idempotency-key file-restore-1",
        example_argv: &[
            "--json",
            "page",
            "file",
