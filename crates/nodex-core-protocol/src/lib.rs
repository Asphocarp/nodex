...
pub const CURRENT_STORE_VERSION: u32 = 126;
...
pub fn store_format(version: u32) -> Option<StoreFormatIdentity> {
    let schema_fingerprint = match version {
        ...
        121 | 122 | 123 => "c9393a19379cb238cb806ec0d011e2ca0d95884a53c5844e42f9ffef44b0571f",
        ...
        126 => CURRENT_STORE_SCHEMA_FINGERPRINT,
        _ => return None,
    };
