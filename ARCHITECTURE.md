...
- `lib/use-workbench-shortcuts.ts`: app-wide stage-first keyboard shortcut mapping for shell commands whose desktop accelerators are owned by Electron's application menu.
